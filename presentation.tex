...
\operation[0]{+ move\_script\_GO\_IN(Map *) : void}
\operation[0]{+ move\_script\_GO\_OUT(Map *) : void}
\operation[0]{+ move\_script\_FLEE(Map *) : void}
\end{class}
\scriptsize
\begin{class}[text width=.23\textwidth]{GhostRed}{-4.5,-6}
\inherit{Ghost}
\operation{+ GhostRed()}
\operation{+ \textasciitilde GhostRed()} 
\end{class}
\begin{class}[text width=.23\textwidth]{GhostBlue}{-1.5,-6}
\inherit{Ghost}
\operation{+ GhostBlue()}
\operation{+ \textasciitilde GhostBlue()} 
\end{class}
\begin{class}[text width=.23\textwidth]{GhostPink}{1.5,-6}
\inherit{Ghost}
\operation{+ GhostPink()}
\operation{+ \textasciitilde GhostPink()} 
\end{class}
\begin{class}[text width=.23\textwidth]{GhostOrange}{4.5,-6}
\inherit{Ghost}
...
\centering
\begin{tikzpicture}
\begin{class}[text width=.575\textwidth]{Scene}{0,0}
\footnotesize
\attribute{+ name : char *}
\operation{+ Scene()}
...
\end{class}
\scriptsize
\begin{class}[text width=.23\textwidth]{SceneMenu}{-4.5,-5.5}
\inherit{Scene}
\operation{+ SceneMenu()}
\operation{+ \textasciitilde SceneMenu()} 
\end{class}
\begin{class}[text width=.23\textwidth]{SceneSetting}{-1.5,-5.5}
\inherit{Scene}
\operation{+ SceneSetting()}
\operation{+ \textasciitilde SceneSetting()} 
\end{class}
\begin{class}[text width=.23\textwidth]{SceneMain}{1.5,-5.5}
\inherit{Scene}
\operation{+ SceneMain()}
\operation{+ \textasciitilde SceneMain()} 
\end{class}
\begin{class}[text width=.23\textwidth]{SceneEnd}{4.5,-5.5}
\inherit{Scene}
\operation{+ SceneEnd()}
